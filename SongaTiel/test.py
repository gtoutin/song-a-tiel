...
a.search(Type.ARTIST, song='birdhouse in your soul', album='flood', artist='they might be giants')
a.search(Type.ARTIST, album='flood', artist='they might be giants')
a.search(Type.ARTIST, artist='they might be giants')
